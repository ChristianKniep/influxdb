...
func NewDatabaseIndex(name string) (index *DatabaseIndex, err error) {
	...
	if index.seriesSketch, err = hll.NewPlus(14); err != nil {
		return nil, err
	} else if index.seriesTSSketch, err = hll.NewPlus(14); err != nil {
		return nil, err
	} else if index.measurementsSketch, err = hll.NewPlus(14); err != nil {
		return nil, err
	} else if index.measurementsTSSketch, err = hll.NewPlus(14); err != nil {
		return nil, err
	}
